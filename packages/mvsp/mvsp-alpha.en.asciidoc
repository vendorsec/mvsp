...
| 1.1 Vulnerability reports ^link:/faq-mvsp.en/{alpha}#FAQ_1_1[FAQ]^
...
| 1.2 Customer testing ^link:/faq-mvsp.en/{alpha}#FAQ_1_2[FAQ]^
...
| 1.3 Self-assessment ^link:/faq-mvsp.en/{alpha}#FAQ_1_3[FAQ]^
| Perform annual (at a minimum) security self-assessments using the latest MVSP release

| 1.4 External testing ^link:/faq-mvsp.en/{alpha}#FAQ_1_4[FAQ]^
...
| 1.7 Incident handling ^link:/faq-mvsp.en/{alpha}#FAQ_1_7[FAQ]^
...
| 1.8 Data handling ^link:/faq-mvsp.en/{alpha}#FAQ_1_8[FAQ]^
...
| 2.1 Single Sign-On ^link:/faq-mvsp.en/{alpha}#FAQ_2_1[FAQ]^
| Implement single sign-on using modern, maintained, and industry standard protocols

| 2.2 HTTPS-only ^link:/faq-mvsp.en/{alpha}#FAQ_2_2[FAQ]^
...
| 2.3 Security Headers ^link:/faq-mvsp.en/{alpha}#FAQ_2_3[FAQ]^
...
| 2.4 Password policy ^link:/faq-mvsp.en/{alpha}#FAQ_2_4[FAQ]^
...
| 2.5 Security libraries ^link:/faq-mvsp.en/{alpha}#FAQ_2_5[FAQ]^
...
| 2.6 Dependency Patching ^link:/faq-mvsp.en/{alpha}#FAQ_2_6[FAQ]^
...
| 2.7 Logging ^link:/faq-mvsp.en/{alpha}#FAQ_2_7[FAQ]^
| Keep logs of:
...
| 2.8 Encryption ^link:/faq-mvsp.en/{alpha}#FAQ_2_8[FAQ]^
...
| 3.4 Time to fix vulnerabilities ^link:/faq-mvsp.en/{alpha}#FAQ_3_4[FAQ]^
...
| 3.5 Build and release process ^link:/faq-mvsp.en/{alpha}#FAQ_3_5[FAQ]^
...
| 4.1 Physical access ^link:/faq-mvsp.en/{alpha}#FAQ_4_1[FAQ]^
...
| 4.2 Logical access ^link:/faq-mvsp.en/{alpha}#FAQ_4_2[FAQ]^
...
| 4.3 Subprocessors ^link:/faq-mvsp.en/{alpha}#FAQ_4_3[FAQ]^
...
| 4.4 Backup and Disaster recovery ^link:/faq-mvsp.en/{alpha}#FAQ_4_4[FAQ]^
